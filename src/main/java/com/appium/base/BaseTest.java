...
public class BaseTest {
	...
	public void driverIntilization(String platform, String udid, String url, String platformVersion)
		...
		if (platform.equalsIgnoreCase("android")) {
			...
			// mobileDriver = new AppiumDriver<MobileElement>(new
	...
	public void initReport() {
		String timestamp = Utility.getTimeStamp();
		report = new ExtentReports(System.getProperty("user.dir") + "/report/ExtentReport" + timestamp + ".html",
				false);
	}
	...
	public void sendEmailableReport() {
		...
		String file = System.getProperty("user.dir") + "//report//";
		String newfile = getTheNewestFile(file, "html").toString();
		attachment.setPath(newfile);
		...
		try {
			email.addTo("nitoradmin@gmail.com", "nitor admin");
		} catch (EmailException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		try {
			email.setFrom("smsonar@gmail.com");
		} catch (EmailException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
